...
Selen AI ระบบสำหรับ monitor AI Event ซึ่งมีตัวอย่างหน้าตา จาก selen-preview.jpg
อยากได้สร้างแบบ cloning กันมากเลย

แล้วเพิ่มเมนูที่เกี่ยวกับ LPR เข้าไป
1. เมนู เพิ่มรถที่ติด Blacklist + VIP (Pre-register) (อาจเพิ่มพวก รูปรถ, ป้ายทะเบียน, รุ่น, ยี่ห้อ เป็นต้น)
2. เมนู ดูรถที่ติด Blacklist + VIP (Pre-register) ทั้งหมดในระบบ มีพวก filter+search
3. Dashboard ภาพรวม AI Event ต่างๆ ทีจับได้ (LPR Event + AI Event ต่างๆ ที่ตรวจจับได้)
